 ...
 */
public class Slime extends Enemy implements HasAbilities {
    /**
     ...
     */
    public Slime(String description, int HP, int AP) {
        super(description, HP, AP);
        introduction = "Blub blub. You encounter a Slime!";
    }
    ...
    public void abilityBasic(Player player) {
        System.out.println(description + " jumps on you!");
    ...
    public void abilityAOE(Player player) {
        System.out.println(description + " spits on your party.");
    ...
    public void abilityFocus(Player player) {
        System.out.println(description + " stares menacingly at you.");
